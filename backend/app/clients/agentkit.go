...
type SwapRequest struct {
	...
	MUSDTAddress string `json:"musdt_address"` // MockUSDT contract address
}
...
func (c *AgentKitClient) ExecuteSwap(tokenAddress, tokenSymbol, amount, direction, musdtAddress string) (*SwapResult, error) {
